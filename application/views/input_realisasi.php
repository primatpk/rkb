    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <?php 
          ...
          ?>
          <h3 class="card-title">Input Realisasi RKB</h3>
        </div>
        <div class="card-body">
            <table class="table">
                <thead>
                ...
                ?>
                  <tr>
                    ...
                    <i class='fa fa-edit'></i>Update Realisasi</a></td>
                  </tr>
                  <?php  $i++;
            ...
            <form action="<?php echo base_url(); ?>user/kirim_realisasi" method="post" enctype="multipart/form-data" onsubmit="return confirm('Anda yakin ingin mengirim data ini?');">
                  <div class="form-row">
        ...
        <div class="modal fade" id="updaterealisasiModal<?php echo $row2->id_rkb ?>" tabindex="-1" arias-labelledby="tambahkegiatanModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('user/update_realisasi'); ?>
