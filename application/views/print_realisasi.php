...
<meta charset="utf-8">
  ...
  <title>Cetak Realisasi RKB</title>
...
?>
  <tr>
    ...
    <td style="border: 1px solid #dddddd; text-align: center; padding: 10px; width: 35%"><?php echo $row->uraian; ?></td>
    ...
    <td style="border: 1px solid #dddddd; text-align: center; padding: 10px; width: 10%"><?php echo $row->realisasi.' '.$row->satuan; ?></td>
    <td style="border: 1px solid #dddddd; text-align: center; padding: 10px; width: 10%"><?php echo $row->skor; ?></td>
    <td style="border: 1px solid #dddddd; text-align: center; padding: 10px; width: 10%"><?php echo $row->nilai; ?></td>
    <td style="border: 1px solid #dddddd; text-align: center; padding: 10px; width: 10%"><?php echo $row->nilai_rkb; ?></td>
  </tr>
  <?php $total = $total + $row->nilai_rkb; $i++;
    endforeach;
  ?>
  <tr>
    <td style="border: 1px solid #dddddd; text-align: left; padding: 10px; background: #D9D9D9" colspan="7"><b>Total</b></td>
    <td style="border: 1px solid #dddddd; text-align: center; padding: 10px; background: #D9D9D9"><b><?php echo $total; ?></b></td>
  </tr>
  <tr>
    <td style="border: 1px solid #dddddd; text-align: left; padding: 10px; background: #D9D9D9" colspan="6"><b>Kategori</b></td>
    <td style="border: 1px solid #dddddd; text-align: center; padding: 10px; background: #D9D9D9" colspan="2"><b><?php 
      if($total > 360){
        echo "ISTIMEWA (A)";
      }
